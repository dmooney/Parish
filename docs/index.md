...
| [Inference Pipeline](design/inference-pipeline.md) | LLM integration, queue, model selection | [ADR-005](adr/005-ollama-local-inference.md), [ADR-010](adr/010-prompt-injection-defenses.md), [ADR-016](adr/016-per-category-inference-providers.md) |
...
| [016](adr/016-per-category-inference-providers.md) | Per-category inference providers | Accepted |
