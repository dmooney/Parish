...
pub struct NpcInfo {
    ...
    pub name: String,
    /// Canonical real name. Always set to the NPC's true name regardless
    /// of introduction state — used for unambiguous chip-click dispatch
    /// since `name` may be a placeholder like "a person" before introduction.
    #[serde(default)]
